...
SurfacePattern.__init = argcheck{
...
SurfacePattern.setExtend = argcheck{
   {name="self", type="cairo.SurfacePattern"},
...
SurfacePattern.getExtend = argcheck{
   {name="self", type="cairo.SurfacePattern"},
   call =
      function(self)
...
SurfacePattern.setFilter = argcheck{
   {name="self", type="cairo.SurfacePattern"},
...
SurfacePattern.getFilter = argcheck{
   {name="self", type="cairo.SurfacePattern"},
   call =
      function(self)
...
SurfacePattern.getSurface = argcheck{
   {name="self", type="cairo.SurfacePattern"},
   call =
      function(self)
...
cairo.GradientPattern = GradientPattern

GradientPattern.addColorStopRGB = argcheck{
...
GradientPattern.addColorStopRGBA = argcheck{
   {name="self", type="cairo.GradientPattern"},
   {name="offset", type="number"},
   {name="red", type="number"},
   {name="green", type="number"},
...
GradientPattern.getColorStopCount = argcheck{
   {name="self", type="cairo.GradientPattern"},
   call =
      function(self)
...
GradientPattern.getColorStopRGBA = argcheck{
   {name="self", type="cairo.GradientPattern"},
...
cairo.LinearGradientPattern = LinearGradientPattern

LinearGradientPattern.__init = argcheck{
...
LinearGradientPattern.getLinearPoints = argcheck{
   {name="self", type="cairo.LinearGradientPattern"},
   call =
      function(self)
...
cairo.RadialGradientPattern = RadialGradientPattern

RadialGradientPattern.__init = argcheck{
...
RadialGradientPattern.getRadialCircles = argcheck{
   {name="self", type="cairo.RadialGradientPattern"},
   call =
      function(self)
         local x0 = ffi.new('double[1]')
...
MeshPattern.beginPatch = argcheck{
   {name="self", type="cairo.MeshPattern"},
   call =
      function(self)
...
MeshPattern.setControlPoint = argcheck{
   {name="self", type="cairo.MeshPattern"},
...
MeshPattern.setCornerColorRGB = argcheck{
   {name="self", type="cairo.MeshPattern"},
...
MeshPattern.setCornerColorRgba = argcheck{
   {name="self", type="cairo.MeshPattern"},
   {name="corner_num", type="number"},
   {name="red", type="number"},
   {name="green", type="number"},
...
MeshPattern.getPatchCount = argcheck{
   {name="self", type="cairo.MeshPattern"},
   call =
      function(self)
...
MeshPattern.getCornerColorRGBA = argcheck{
   {name="self", type="cairo.MeshPattern"},
   {name="patch_num", type="number"},
   {name="corner_num", type="number"},
   call =
...
MeshPattern.getControlPoint = argcheck{
   {name="self", type="cairo.Pattern"},
   {name="patch_num", type="number"},
   {name="point_num", type="number"},
   call =
