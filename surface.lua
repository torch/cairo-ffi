...
Surface.supportsMimeType = argcheck{
   {name="self", type="cairo.Surface"},
   {name="mime_type", type="string"},
   call =
...
Surface.getFontOptions = argcheck{
   {name="self", type="cairo.Surface"},
...
Surface.markDirtyRectangle = argcheck{
   {name="self", type="cairo.Surface"},
   {name="x", type="number"},
   {name="y", type="number"},
   {name="width", type="number"},
...
Surface.setDeviceOffset = argcheck{
   {name="self", type="cairo.Surface"},
...
Surface.getDeviceOffset = argcheck{
   {name="self", type="cairo.Surface"},
   call =
      function(self)
...
Surface.setFallbackResolution = argcheck{
   {name="self", type="cairo.Surface"},
...
Surface.getFallbackResolution = argcheck{
   {name="self", type="cairo.Surface"},
   call =
      function(self)
...
Surface.hasShowTextGlyphs = argcheck{
   {name="self", type="cairo.Surface"},
   call =
      function(self)
